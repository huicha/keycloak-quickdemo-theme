          ...
          <table border="0" width="100%" cellpadding="0" cellspacing="0" align="center" style="max-width:600px;margin:auto;" class="email-container">
            ...
            <tr>
              <td style="text-align:center;padding:4% 0;font-family:sans-serif;font-size:12px;line-height:1.2;color:#bbb;">
                 <img src="https://i.imgur.com/kIFLxJV.png" alt="Tienda Viajes Movistar" width="116" height="41" border="0" align="left"> <span class="mobile-link--footer">Operador responsable Movi Viajes. <span class="mobile-link--footer">Legajo Nro.13586 - EVT Disp. 713/08 </span>- Compromiso Tienda Viajes Movistar</span>
                <br>
                </td>
              </tr>
              <!-- Footer : END -->
